...
Node * pointerToMax(LinkedList *list) {
  ...
  return maxPtr; // STUB!  Replace this line with correct code
}
...
Node * pointerToMin(LinkedList *list) {
  ...
  return minPtr; // STUB!  Replace this line with correct code
